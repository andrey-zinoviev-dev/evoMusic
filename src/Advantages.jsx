        ...
        <ul className="advantages__ul">
          ...
          <li key="adv_02" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <p className="advantages__ul-li-p">Профессионально записываем песни в студии в школе и снимаем клипы видео продакшеном</p>
            </div>
            <p>Запись</p>
          ...
          <li key="adv_04" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <p className="advantages__ul-li-p">Мастеринг песен партнерами Pravda Records и продвижение Craft Core</p>
            </div>
          </li>
