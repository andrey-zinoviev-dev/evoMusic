        ...
        <ul className="advantages__ul">
          ...
          <li key="adv_01" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <div className="advantages__ul-li-text-color"></div>
              <p className="advantages__ul-li-text-p">Отработка зажимов и стеснений при выступлении, а также сценической речи</p>
            </div>
            <div className="advantages__ul-li-category">
              ...
              <p className="advantages__ul-li-p">Выступления</p>
            </div>
          ...
          <li key="adv_02" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <div className="advantages__ul-li-text-color"></div>
              <p className="advantages__ul-li-text-p">Профессионально записываем песни в студии в школе и снимаем клипы видео продакшеном</p>
            </div>
            <div className="advantages__ul-li-category">
          ...
          <li key="adv_04" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <div className="advantages__ul-li-text-color"></div>
              <p className="advantages__ul-li-text-p">Мастеринг песен партнерами Pravda Records и продвижение Craft Core</p>
            </div>
            <div className="advantages__ul-li-category">
          ...
          <li key="adv_03" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <div className="advantages__ul-li-text-color"></div>
              <p className="advantages__ul-li-text-p">Время занятий с 11 до 23 ты выбираешь сам, заморозка уроков на любой срок - уроки не сгорят, пока их не отходишь  </p>
            </div>
            <div className="advantages__ul-li-category">
