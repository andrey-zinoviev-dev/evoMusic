        ...
        <ul className="advantages__ul">
          ...
          <li key="adv_05" className="advantages__ul-li">
            <div className="advantages__ul-li-text">
              ...
              <div className="advantages__ul-li-text-color"></div>
              <p className="advantages__ul-li-text-p">Мы работаем в центре Москвы с действующими музыкантами-универсалами с большим опытом работы, а занятия проходят строго по твоим потребностям в выбранном тобой направлении</p>
            </div>
            <div className="advantages__ul-li-category">
