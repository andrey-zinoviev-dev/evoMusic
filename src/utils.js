...
export const questions = [
    {text: "Смогу ли я изучать разные предметы?", answer: "Да, формат нашего обучения предполагает мультинапрааленность. Ты получаешь всеобъемлющие знания в сфере музыкального образования, можешь посещать  все направления в школе"},
    ...
    {text: "Я мечтаю зарабатывать музыкой, научится писать её под заказ, но как это сделать?", answer: "Ты обратился по адресу! У нас разработана специальная программа по написанию музыки с нуля до про, а также мы рассказываем, где искать клиентов и знакомим с крупными студиями звукозаписи"},
